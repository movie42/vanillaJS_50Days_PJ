...
var Ball = /*#__PURE__*/function () {
  ...
  _createClass(Ball, [{
    key: "draw",
    value: function draw(ctx, stageWidth, stageHeight, block) {
      this.x += this.vx;
      this.y += this.vy;
      this.bounceWindow(stageWidth, stageHeight);
      this.bounceBlock(block);
      ctx.fillStyle = "#26C3E4";
      ctx.beginPath();
    ...
    key: "bounceWindow",
    value: function bounceWindow(stageWidth, stageHeight) {
    ...
    key: "bounceBlock",
    value: function bounceBlock(block) {
...
exports.Ball = Ball;
},{}],"src/block.js":[function(require,module,exports) {
"use strict";
...
var App = /*#__PURE__*/function () {
  function App() {
    ...
    this.resize();
    this.ball = new _ball.Ball(this.stageWidth, this.stageHeight, 60, 10);
    this.block = new _block.Block(700, 30, 300, 450);
...
new App();
},{"./ball.js":"src/ball.js","./block":"src/block.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
